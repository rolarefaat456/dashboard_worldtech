                                    ...
                                    child: Row(
                                      children: [
                                        AspectRatio(
                                          aspectRatio: 1,
                                          child: CircleAvatar(
                                            backgroundImage: (value.profilee?['data'] != null &&
                    value.profilee['data']['image'] != null &&
                    value.profilee['data']['image'].isNotEmpty)
      ? NetworkImage("${value.baseurl}/${value.profilee['data']['image']}")
      : null,
  child: (value.profilee?['data'] == null ||
          value.profilee['data']['image'] == null ||
          value.profilee['data']['image'].isEmpty)
      ...
      : null,
                          ...
                          Container(
                            ...
                            child: Text(
                              widget.title,
                              style: AppTextStyles.style24w500(context).copyWith(fontFamily: 'Tajawal')
                            ),
                          ),
                        ],
                      ),
